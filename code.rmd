...
The maximisation of the likelihood function is run with respect to $\mathbf\beta$, and continued to until some convergence is reached.
...
lines(sort(y), density, col = "blue", lwd = 2)
```
