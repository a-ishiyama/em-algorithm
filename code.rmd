...
$$\begin{aligned}\frac{\mathrm d}{\mathrm d \theta}log (f_Z(z))&= \sum_{i=1}^{n}\frac{1}{\theta}-\sum_{i=1}^{n}log(z_i) \\&= \frac{n}{\theta}-\sum_{i=1}^{n}log(z_i)\end{aligned}$$
...
$$\begin{aligned}\frac{\mathrm d}{\mathrm d p} log (f_{\delta}(d))&= \frac{\sum_{i=1}^{n}\delta_i}{p}-\frac{\sum_{i=1}^{n}(1-\delta_i)}{1-p} = 0 \end{aligned}$$
...
$$\frac{\mathrm d^2}{\mathrm d \theta^2} log (f_Z(z))= -n\theta^{-2}$$ given that,

$$\frac{\mathrm d}{\mathrm d \theta}log (f_Z(z)) = \frac{n}{\theta}-\sum_{i=1}^n log(z_i)$$
...
$$\frac{\mathrm d^2}{\mathrm dp^2}log (f_{\delta}(d)) = \frac{-\sum_{i=1}^n \delta_i}{p^2}+\frac{\sum_{i=1}^n (1-\delta_i)}{(1-p)^2}$$

given that,

$$\frac{\mathrm d}{\mathrm d p} log (f_{\delta}(d))= \frac{\sum_{i=1}^{n}\delta_i}{p}-\frac{\sum_{i=1}^{n}(1-\delta_i)}{1-p}$$
